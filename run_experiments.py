# /forecasting/run_experiments.py (VERSÃO COMPLETA E CORRIGIDA)
...
# --- MUDANÇA AQUI: Definindo a variável de ambiente ---
os.environ['NIXTLA_ID_AS_COL'] = '1'

# --- MUDANÇA AQUI: Importando todas as funções necessárias ---
...
# --- MUDANÇA AQUI: Incluindo todos os modelos na lista de experimentos ---
EXPERIMENTS = {
...
def run():
    # (O corpo da função run não muda)
